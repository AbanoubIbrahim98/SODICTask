    ...
    public partial class db_init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicAttributes", x => x.DynamicAttributeId);
                    table.ForeignKey(
                        name: "FK_DynamicAttributes_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttributeValues_DynamicAttributes_DynamicAttributeId",
                        column: x => x.DynamicAttributeId,
                        principalTable: "DynamicAttributes",
                        principalColumn: "DynamicAttributeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileProds", x => x.FileId);
                    table.ForeignKey(
                        name: "FK_FileProds_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeValues_DynamicAttributeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DynamicAttributes_CategoryId",
                table: "DynamicAttributes",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_FileProds_ProductId",
                table: "FileProds",
                column: "ProductId");
